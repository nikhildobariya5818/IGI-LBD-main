...
export default function InvoicePDF({
  ...
  const backgroundImageSrc = isSmall
    ? "/6452895166_29-05-2026.jpg"
    : "/17-11.jpg"

  const titleContainerStyle = isSmall
    ? { ...styles.titleContainer, paddingTop: "42px", marginBottom: "4px", marginLeft: "10px" }  //14 *8.5
  ...
  const section1Left = section1Layout.marginLeft ?? (isSmall ? -5 : 112)  //-12
  ...
  const section2Top = section2Layout.marginTop ?? (isSmall ? 4 : 3)  // ? 7 :3
  const section2Left = section2Layout.marginLeft ?? (isSmall ? 35 : 37)

  const section3Top = section3Layout.top ?? 415 //414
  const section3Left = section3Layout.left ?? (isSmall ? 52.5 : 49.5)
